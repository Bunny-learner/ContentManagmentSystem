...
const unseen=asynchandler(async(req,res,next)=>{
    ...
    try {
        ...
        const temp=await notifydb.find({role:role,seen:false,to:name})
        console.log(temp)
...
export { signdata,searchresults,getdraftpost,viewpost,changestatus,msgs,getreqposts,unseen,addingnotif, posturls,logindata,logs, allposts,addpost,changerole,users,dashdata,role,logout }
