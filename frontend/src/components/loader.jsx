...
import '../css/loader.css'; // Assuming you'll add CSS for animation here

const Loader = () => {
  return (
    <div className="loader-container"> {/* Added a container div for centering/styling */}
      <svg
        ...
        width="56px"
        viewBox="0 0 56 56"
        className="loader" // Using className for React
      >
        ...
        <g transform="translate(2,2)">
          <g
            ...
            strokeLinecap="round" // React uses camelCase for SVG attributes
          ...
          >
            <circle
              ...
              cy="26"
              cx="26"
              strokeWidth="2.5" // React uses camelCase for SVG attributes
            ...
            <g strokeLinecap="round" stroke="hsl(35,90%,90%)">
              ...
              <g strokeWidth="0" fill="hsl(35,90%,90%)">
                <path
                  ...
                  clipPath="url(#sand-mound-top)" // React uses camelCase for SVG attributes
                ></path>
                <path
